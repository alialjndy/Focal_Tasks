...
use App\Exceptions\NotLoggedUser;
...
class MovieController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($sortType === 'desc'){
            $movie->orderBy('rating', 'desc')->orderBy('release_year', 'desc');
        }else{
            // If the view is ascending
            $movie->orderBy('rating', 'desc')->orderBy('release_year','asc');
        }
    ...
    {
        //vaildation the incoming request data.
